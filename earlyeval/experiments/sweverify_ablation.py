...
from earlyeval.core.paths import load_paths
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "to configs/earlyeval.yaml main_model.safe_label_min_step."
        ),
    )
...
def _selected_folds(cfg: EarlyEvalConfig, args: argparse.Namespace) -> list[dict[str, Any]]:
...
def _build_plan(cfg: EarlyEvalConfig, args: argparse.Namespace, run_dir: Path) -> tuple[list[dict[str, Any]], list[list[str]]]:
