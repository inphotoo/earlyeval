...
from earlyeval.experiments.sweverify_ablation import _summarize


DEFAULT_ROOT = Path("paper/experiments/earlyeval_lightgbm")
...
def main() -> int:
    ...
    if args.execute:
        ...
        if args.refresh_reporting_detail:
            proc = subprocess.run([sys.executable, "-m", "earlyeval.experiments.build_reporting_detail"])
