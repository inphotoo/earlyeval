...
from earlyeval.core.legacy_paths import answer_module_root, require_path, shared_prefix_table_filtered_path
...
class DualHeadRunSpec:
    ...
    output_subdir: str = "earlyeval_current_safe_stop_dual_head"
