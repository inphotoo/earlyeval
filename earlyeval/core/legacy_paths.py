...
def legacy_answer_module_root() -> Path:
    ...
    vendored earlyeval-owned source tree. This helper remains for audit reports
...
def answer_module_root() -> Path:
    """Return the earlyeval-owned answer-aware module root.

    The GitHub release is code-self-contained: the active answer-aware trainer,
    feature code, and posthoc scripts live under `earlyeval/vendor/`. Do not fall
