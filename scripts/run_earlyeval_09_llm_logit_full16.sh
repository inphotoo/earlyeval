...
CACHE_ROOT="${CACHE_ROOT:-${PACKAGE_ROOT}/paper/experiments/earlyeval_lightgbm/model_compare/llm_logit_${MODEL_TAG}_full16_cache}"
OUTPUT_ROOT="${OUTPUT_ROOT:-${PACKAGE_ROOT}/paper/experiments/earlyeval_lightgbm/model_compare/llm_logit_${MODEL_TAG}_full16}"
