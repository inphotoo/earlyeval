...
CACHE_ROOT="${CACHE_ROOT:-${PACKAGE_ROOT}/paper/experiments/earlyeval_lightgbm/model_compare/bert_codebert_finetune_full16_cache}"
OUTPUT_ROOT="${OUTPUT_ROOT:-${PACKAGE_ROOT}/paper/experiments/earlyeval_lightgbm/model_compare/bert_codebert_finetune_full16_e3}"
