...
rq_final_full16_models_string() {
  local IFS=" "
  printf "%s" "${RQ_FINAL_FULL16_MODEL_IDS[*]}"
}

rq_final_excluded_models_string() {
  local IFS=" "
  printf "%s" "${RQ_FINAL_EXCLUDED_MODEL_IDS[*]}"
}
