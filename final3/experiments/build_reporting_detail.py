...
ROOT = Path("paper/experiments/rq_final_lightgbm_17")
...
def _sweverify_split_rows_from_main_folds() -> pd.DataFrame:
    ...
    The standalone ``rq_final_all_dataset_split_check`` artifact uses a uniform
...
def _split_audit_artifacts() -> dict[str, Any]:
    split_index = pd.read_csv("paper/experiments/rq_final_all_dataset_split_check/splits/split_index.csv")
    ...
    prefix_audit = pd.read_csv("paper/experiments/rq_final_smoke/checks/prefix_audit_summary.csv")
