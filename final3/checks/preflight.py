...
from final3.core.paths import ProjectPaths, load_paths, package_root, resolve_repo_path
...
CURRENT_PAPER_TABLES = [
    ...
    "table_ablation_default_reg_full16.csv",
    "table_ablation_fine_grained_full16.csv",
    "table_architecture_compare_full16.csv",
    "table_architecture_run_status.csv",
    "table_llm_logit_lomo_representative_full16.csv",
    "table_llm_logit_lomo_threshold_summary_full16.csv",
    "table_lr_tfidf_full16.csv",
    "table_main_aggregate.csv",
    "table_main_per_fold.csv",
    "table_main_valid_accuracy_frontier.csv",
    "table_min_step_k_full16.csv",
    "table_policy_mode_full16.csv",
    "table_prefix_audit_summary.csv",
    "table_rank_change_full16.csv",
    "table_robustness.csv",
    "table_robustness_loo.csv",
    "table_score_mode_full16.csv",
    "table_split_check_counts.csv",
    "table_stop_signal_decision_lift_by_prefix_full16.csv",
    "table_stop_signal_decision_lift_by_trajectory_full16.csv",
    "table_stop_signal_stop_composition_full16.csv",
    "table_success_examples_full16.csv",
    "table_token_by_decision_round_full16.csv",
    "table_token_summary_full16.csv",
]

CURRENT_PAPER_FIGURES = [
    "lr_tfidf_selected_full16_aggregate.png",
...
def _current_paper_paths() -> list[tuple[str, Path, bool]]:
    ...
    out: list[tuple[str, Path, bool]] = [
        ...
        (
            ...
            root / "paper" / "experiments" / "rq_final_lightgbm_17" / "reporting_detail"
    ...
    rq_final = root / "configs" / "rq_final.yaml"
    out.append(("config.rq_final", rq_final, True))
    if rq_final.exists():
        cfg = yaml.safe_load(rq_final.read_text(encoding="utf-8")) or {}
